...
pacstrap -K /mnt base base-devel linux linux-firmware git reflector linux-headers nvidia-dkms nvidia-utils nvidia-settings vulkan-icd-loader lib32-nvidia-utils lib32-vulkan-icd-loader
